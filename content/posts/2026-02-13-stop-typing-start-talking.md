...
Whether I am communicating with [Claude](https://www.anthropic.com/), [Gemini](https://blog.google/products/ai/gemini-ai/), [GitHub Copilot](https://github.com/features/copilot), or just replying to messages on LinkedIn, the volume of text I need to produce has gone up. That is why I decided to stop typing and start talking.
...
This isn't my first attempt at voice control. A couple of years ago, GitHub released [GitHub Copilot Voice](https://githubnext.com/projects/copilot-voice/), which allowed you to code by talking. 
...
The turning point came recently when [Andrew Connell](https://andrewconnell.com/) (AC) told me he was using a tool called Wispr Flow to handle dictation. He wasn't using it to write `if` statements; he was using it to dump thoughts into documents, emails, AI prompts, and more.
...
The beauty of [Handy](https://handy.computer/) lies in its simplicity. Use tools to remove friction, not add to it. Handy starts up when my device boots, and it stays out of the way until I need it.
...
{{< blockquote type="tip" text="When choosing a productivity tool, look for ones that integrate seamlessly into your OS. If you have to open a dedicated app window to use it, you probably won't use it." >}}
...
*   [Handy on GitHub](https://handy.computer/)
*   [GitHub Copilot Voice](https://githubnext.com/projects/copilot-voice/)
*   [Andrew Connell](https://andrewconnell.com/)
